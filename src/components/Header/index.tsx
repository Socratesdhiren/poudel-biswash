            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="flex items-center justify-end gap-2 pr-16 lg:pr-0">
                <a
                  ...
                  className="ease-in-up font-small hidden rounded-md bg-primary px-3 py-3 text-base text-white shadow-btn transition duration-300 hover:bg-opacity-90 hover:shadow-btn-hover md:block md:px-3 lg:px-3 xl:px-3"
                >
                  <p>
                    <svg
                      fill="#fff"
                  ...
                  <p>
                    ...
                    >
                      <path
                        ...
                        stroke-width="2"
                        d="M21 12.79V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7.79l-7-5-7 5z"
                      />
                    </svg>
                  </p>
                </a>
